...
#set_property PACKAGE_PIN B13 [get_ports {o_Tx_Active}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {o_Tx_Active}]
###Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
#set_property PACKAGE_PIN F14 [get_ports {o_Tx_Done}]
...
set_property PACKAGE_PIN L14 [get_ports cs_n]
set_property IOSTANDARD LVCMOS33 [get_ports cs_n]
##Bank = CONFIG, Pin name = IO_L2P_T0_D03_14,				Sch name = QSPI_DQ3
set_property PACKAGE_PIN M14 [get_ports send_c]
set_property IOSTANDARD LVCMOS33 [get_ports send_c]
##Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = QSPI_CSN
set_property PACKAGE_PIN L13 [get_ports mul_done]
set_property IOSTANDARD LVCMOS33 [get_ports mul_done]


##Pmod Header JXADC
##Bank = 15, Pin name = IO_L9P_T1_DQS_AD3P_15,				Sch name = XADC1_P -> XA1_P
set_property PACKAGE_PIN A13 [get_ports done]
...
set_property PACKAGE_PIN R10 [get_ports sclk]
set_property PACKAGE_PIN T8 [get_ports {K_in[1]}]
set_property PACKAGE_PIN R7 [get_ports {K_in[4]}]
set_property PACKAGE_PIN T6 [get_ports {K_in[3]}]
set_property PACKAGE_PIN R8 [get_ports {K_in[2]}]
set_property PACKAGE_PIN U8 [get_ports {K_in[0]}]
set_property PACKAGE_PIN B8 [get_ports {N_in[1]}]
set_property PACKAGE_PIN C11 [get_ports {M_in[4]}]
set_property PACKAGE_PIN C10 [get_ports {M_in[3]}]
set_property PACKAGE_PIN D9 [get_ports {N_in[4]}]
set_property PACKAGE_PIN B9 [get_ports {N_in[2]}]
set_property PACKAGE_PIN C9 [get_ports {N_in[3]}]
set_property PACKAGE_PIN A10 [get_ports {M_in[2]}]
set_property PACKAGE_PIN A9 [get_ports {M_in[1]}]
set_property PACKAGE_PIN D10 [get_ports {M_in[0]}]
set_property PACKAGE_PIN A8 [get_ports {N_in[0]}]
